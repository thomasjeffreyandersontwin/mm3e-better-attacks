...
/**
 * Shows the resource display for a token (hero points, injuries, fatigue, luck)
 * @param {Token} token - The token to show the resource display for
 */
...
/**
 * Shows the action buttons for a token
 * @param {Token} token - The token to show the action buttons for
 */
...
/**
 * Shows attack details box below the hovered attack button
 * @param {Token} token - The token the attack belongs to
 * @param {Object} attack - The attack data
 * @param {HTMLElement} button - The attack button being hovered
 */
...
/**
 * Expands the background panel to accommodate the details box
 * @param {Token} token - The token
 * @param {HTMLElement} detailsBox - The details box element
 */
...
/**
 * Contracts the background panel back to original size
 * @param {Token} token - The token
 */
...
/**
 * Shows the power menu for a token
 * @param {Token} token - The token to show the menu for
 */
...
/**
 * Hides the power menu for a token
 * @param {Token} token - The token to hide the menu for
 */
...
/**
 * Shows power details for powers WITH sliders
 * @param {Token} token - The token the power belongs to
 * @param {Object} power - The power data
 * @param {HTMLElement} button - The power button being hovered
 * @param {HTMLElement} powerRow - The flex row container
 */
...
/**
 * Shows power details for powers WITHOUT sliders
 * @param {Token} token - The token the power belongs to
 * @param {Object} power - The power data
 * @param {HTMLElement} button - The power button being hovered
 */
...
/**
 * Hides power details box
 * @param {Token} token - The token to hide details for
 */
...
/**
 * Checks if a power has a "Reaction" extra
 * @param {Object} power - The power to check
 * @returns {boolean} - True if the power has a Reaction extra
 */
...
/**
 * Checks if a power has "Reaction" mentioned in its notes
 * @param {Object} power - The power to check
 * @returns {boolean} - True if the power mentions Reaction in notes
 */
...
/**
 * Maps system trait names/paths to truncated display names (like attacks)
 * @param {string} systemTrait - The system trait name or path
 * @returns {string} - The truncated display name
 */
